...
@app.on_message(filters.command("blacklistadffffffffffffffffffffffff_chat") & filters.user(SUDOERS))
@capture_err
...
@app.on_message(filters.command("whiteliadffffffffffffffffffst_chat") & filters.user(SUDOERS))
@capture_err
...
@app.on_message(filters.command("blacklistadffffffffffffffffffed_chats") & filters.user(SUDOERS))
@capture_err
